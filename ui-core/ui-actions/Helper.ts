...
export namespace Helper {
    ...
    export class Assertion {
        ...
        public expectNotEqual(element: any, expecred: any) {
            return assert.eventually.notEqual(element.first().getText(), expecred, 'Verification Error !');
        }

        public expectToEqual(element: any, expecred: any) {
            return assert.eventually.equal(element.first().getText(), expecred, 'Verification Error !');
        }

        public expectToContain(element: any, expecred: any) {
            return assert.eventually.include(element.first().getText(), expecred,'Verification Error !');
        }
