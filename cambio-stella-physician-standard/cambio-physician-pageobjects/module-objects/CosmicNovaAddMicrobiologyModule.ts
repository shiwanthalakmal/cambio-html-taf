...
const log = Factory.getLogger("Page.CosmicNovaAddMicrobiologyModule");

export class CosmicNovaAddMicrobiologyModule extends PageBase{
    ...
    constructor(){
        super();
        const element = Elements.CosmicNovaAddMicrobiologyModule;
