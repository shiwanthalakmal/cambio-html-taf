...
const log = Factory.getLogger("Page.CosmicNovaAddMedicationModule");

export class CosmicNovaAddMedicationModule extends PageBase{
    ...
    constructor(){
        super();
        const element = Elements.CosmicNovaAddMedicationModule;
