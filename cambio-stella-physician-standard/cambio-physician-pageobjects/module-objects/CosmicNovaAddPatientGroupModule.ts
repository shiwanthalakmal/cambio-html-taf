...
const log = Factory.getLogger("Page.CosmicNovaAddPatientGroupModule");

export class CosmicNovaAddPatientGroupModule extends PageBase{
    ...
    constructor(){
        super();
        const element = Elements.CosmicNovaAddPatientGroupModule;
